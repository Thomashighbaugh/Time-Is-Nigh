(this["webpackJsonptime-is-nigh"] =
  ...
  {
    14: function (n, e, t) {
      n.exports = t.p + "static/media/logo.b770a68f.svg";
    },
    35: function (n, e, t) {
      n.exports = t(51);
    },
    51: function (n, e, t) {
      ...
      function k() {
        var n = Object(o.a)(["\n  animation: ", " 0.25s linear infinite;\n"]);
        return (
          (k = function () {
            return n;
          }),
      ...
      var T = c.c.form(B()),
        ...
        L = c.c.h1(
          x(),
          function (n) {
            return n.warning ? "#F0285B" : "#343a40";
          },
          function (n) {
            return n.blink ? N : null;
          }
        ),
        R = Object(c.c)(l.b)(y()),
        A = Object(c.c)(l.a)(V()),
        ...
        Z = function (n) {
          ...
          return r.a.createElement(
            ...
            r.a.createElement(
              m.a.Group,
              { controlId: "formCountdownMinutes" },
              r.a.createElement(
                m.a.Label,
                { htmlFor: "timer" },
                "Countdown (minutes)"
              ),
              r.a.createElement(m.a.Control, {
                placeholder: "0",
                onChange: t,
                id: "timer",
                inputProps: { min: "0" },
            ...
            r.a.createElement(
              Y,
              { disabled: 0 === e, variant: "primary", type: "submit" },
              i ? "Reset" : "Start"
            )
          );
        };
      ...
      var $ = Z,
        ...
        en = function (n) {
          ...
          return r.a.createElement(
            ...
            r.a.createElement(
              ...
              r.a.createElement(
                ...
                r.a.createElement(
                  ...
                  {
                    blink: h <= 10 && h > 0 && 0 === l,
                    warning: h <= 20 && h > 0 && 0 === l,
                  },
                  "".concat(l, ":").concat("0".concat(h % 60).slice(-2))
                )
              ),
              h > 0
                ? ((e = m),
                  (t = r.a.createElement(
                    nn.a,
                    { className: "col-4" },
                    r.a.createElement(R, { onClick: v })
                  )),
                  (a = r.a.createElement(
                    nn.a,
                    { className: "col-4" },
                    r.a.createElement(A, { onClick: i })
                  )),
                  e ? t : a)
                : null
            ),
            r.a.createElement(
              J,
              { variant: "primary", "aria-label": "Rate Controls" },
              r.a.createElement(
                P,
                {
                  size: "lg",
        ...
        hn = function () {
          return r.a.createElement(
            ...
            r.a.createElement(
              nn.a,
              { className: "col-8" },
              r.a.createElement(Q, { src: rn.a, alt: "spinning hourglass" })
            ),
            r.a.createElement(W, null, "The Time is Nigh")
          );
        },
        vn = function () {
          return r.a.createElement(
            ...
            r.a.createElement(
              nn.a,
              { className: "col-6" },
              r.a.createElement(U, { src: rn.a, alt: "" })
            )
          );
        };
      function on() {
            ...
            r.a.createElement(
              ...
              r.a.createElement($, {
                ...
                handleSubmit: function (n) {
                  n.preventDefault(), p(!1), C(!0), i(60 * m - 1);
                },
                handleChange: function (n) {
                  l(parseInt(n.target.value, 10)), C(!1);
                },
                resetCounter: function (n) {
                  n.preventDefault(), p(!1), i(0), C(!1), l(0);
                },
              }),
              h <= w && O && h >= 1
                ? r.a.createElement(F, null, "More than halfway there!")
                : null,
              0 === h && O ? r.a.createElement(F, null, "Time's up!") : null,
      ...
      i.a.render(r.a.createElement(mn, null), document.getElementById("root"));
    },
  },
  [[35, 1, 2]],
]);
//# sourceMappingURL=main.9b8387d4.chunk.js.map
